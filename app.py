                        ...
                        if old_product == edit_product and old_prod_cat == edit_product_category:
                            ...
                            if qty_diff != 0:
                                if old_prod_cat == 'RM Product':
                                    ...
                                    execute_query("UPDATE rm_stock_movement SET qty = ? WHERE reference_id = ? AND transaction_type = 'SALE'",
                    ...
                    try:
                        ...
                        if not existing_challan.empty:
                            ...
                            if available < qty:
                                ...
                                # We allow the sale to proceed per previous requirements, but warn the user
                    ...
                    if st.form_submit_button("💾 Save Changes", type="primary"):
                        ...
                        if edit_product_category == 'RM Product':
                            ...
                            if edit_product_category != 'RM Product':
                                ...
                                # Or simply call consume_rm_for_fg_sale which adds NEW consumption. 
                                # Ideally, you'd delete old consumption movements too.
                                pass 
